...
{
    XL = move_list[(num_of_steps-total_steps)*4];
    XR = move_list[((num_of_steps-total_steps)*4)+1];
    YD = move_list[((num_of_steps-total_steps)*4)+2];
    YU = move_list[((num_of_steps-total_steps)*4)+3];
