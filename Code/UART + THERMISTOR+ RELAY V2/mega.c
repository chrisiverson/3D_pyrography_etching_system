...
if ( XR == 0 && XL == 0 && YU == 0 && YD == 0 && reset && image_choice == 0 && z_endstopvar_cal && reset_step == 0)
{
    ZU = 0;
    ZD = 10000;
    reset_step = 1;
...
if ( XR == 0 && XL == 0 && YU == 0 && YD == 0 && reset && image_choice == 0 && !z_endstopvar_cal && reset_step == 1)
{
  ZU = 10000;
  ZD = 0;
  z_with_object_ht = 0;
...
if (ZD == 0 && reset_step == 2 && z_endstopvar_cal && !z_endstopvar_max)
{
  automatic = 0;
  ZD = 0;
  ZU = 0;
...
///////////////////////AUTO-IMAGE DRAWING/////////////////////////////
if ( XR == 0 && XL == 0 && YU == 0 && YD == 0 && reset && image_choice == 1 && drawing_image == 0 && image_done == 0)
{
  drawing_image = 1;
  total_steps = sizeof(move_list)/8;
...
{
    XL = 10*move_list[(num_of_steps-total_steps)*4];
    XR = 10*move_list[((num_of_steps-total_steps)*4)+1];
    YD = 10*move_list[((num_of_steps-total_steps)*4)+2];
    YU = 10*move_list[((num_of_steps-total_steps)*4)+3];
    
    total_steps--;
    Serial2.write((num_of_steps / total_steps) * 100 + 400);
    
}


  if (total_steps == 0 && drawing_image)
  {
    drawing_image = 0;
    automatic = 0;
    image_done = 1;
...
if (ZD > 0 && z_endstopvar_min && z_endstopvar_cal) 
{
  z_with_object_ht--;
    // turn LED on:
