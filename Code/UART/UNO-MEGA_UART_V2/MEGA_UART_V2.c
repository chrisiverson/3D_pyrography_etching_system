 ...
 else if(buttonvar || buttonvar2)
{
 ...
 //////////// MANUAL JOYSTICK //////////
// y-direction UP
  if(((((UD < UPMID - MID) || (randomflag ==1)) || (YU > 0)) && y_endstopvar_min ) && (readinput == 11 )){
   digitalWrite(DWN, LOW);
   digitalWrite(61,LOW);
   digitalWrite(UP, LOW);
   digitalWrite(60,HIGH);
  ...
  // y-direction DOWN
  if(((((UD > UPMID + MID) || (YD > 0)) && y_endstopvar_max )) && (readinput == 11))
  {
   digitalWrite(UP, LOW);
   digitalWrite(61,HIGH);
   //digitalWrite(DWN, LOW);
  ...
  //x-direciton RIGHT
  if(((((LR < LRMID - MID) || (XR > 0)) && x_endstopvar_max )) && (readinput == 11))
  {// min
  ...
  //x-direction LEFT
  if(((((LR > LRMID + MID) || (XL > 0)) && x_endstopvar_min )) && (readinput == 11))
  {
   digitalWrite(55,LOW);
   //digitalWrite(RT, LOW);
   digitalWrite(54,HIGH);
