function [x_move, y_move, x_fin, y_fin, final_x, final_y, num_steps ] = conv_to_moves( Im_array, current_x, current_y )
...
x_fin(1,1)=next_x-current_x;
x_move(1,1) = next_x-current_x;
y_fin(1,1)=next_y;
y_move(1,1)=current_y-next_y;
...
for i = 1:num_steps
    ...
    y_move(i+1) = (Y-y_fin(i))-(Y-next_y);
    Im_outline(next_x,next_y) = 0;
end

end

final_x=x_fin(num_steps);
final_y=y_fin(num_steps);
end