...
void setup()
{
  ...
  pinMode(9, OUTPUT);
  digitalWrite(outPin, stateRelay); //initialize relay to 0 at start of program
...
void loop()
{
     ...
     //{
        ...
        if(input == 5)
        {
          ...
          lcd.print("Platform");
          stateRelay = LOW;
          digitalWrite(outPin,stateRelay);// low means RELAY ON, HIGH means RELAY OFF
          //delay(200);
        }
        ...
        else if(input == 101)
        {
          ...
          {
            stateRelay = HIGH;
            digitalWrite(outPin, stateRelay); //turn off relay
          }
          else if(stateRelay == HIGH)
          {
            stateRelay = LOW;
            digitalWrite(outPin, stateRelay); //turn on relay
          }
          input = 126; //display the manual mode screen and temperature
        }
        else if (input == 7)
        {
          lcd.clear();
        ...
        else if (input >= 150 && input <= 250)
        {
          ...
          if(input == 100)
          {
            input = 10;
            stateRelay = HIGH;
            digitalWrite(outPin, stateRelay); //turn off relay once drawing complete
          }
